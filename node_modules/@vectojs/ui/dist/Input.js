...
var Input = class extends UIComponent {
  ...
  getLayout() {
    ...
    const engine = new import_core3.LayoutEngine(1e6, 1e3, {
  ...
  render(r) {
    ...
    const baseline = this.padding + (0, import_core3.cssLineBoxBaseline)(this.font, editorLineHeight);
