...
// src/Link.ts
import { sanitizeUrl } from "@vectojs/core";
...
// src/Input.ts
import { cssLineBoxBaseline, LayoutEngine as LayoutEngine2 } from "@vectojs/core";
var Input = class extends UIComponent {
  ...
  getLayout() {
    ...
    const engine = new LayoutEngine2(1e6, 1e3, {
...
// src/TextArea.ts
import { cssLineBoxBaseline as cssLineBoxBaseline2, LayoutEngine as LayoutEngine3 } from "@vectojs/core";
...
var TextArea = class extends UIComponent {
  ...
  computeLines() {
    ...
    let pStart = 0;
    const fSize = fontSizePx(this.font);
    const engine = new LayoutEngine3(innerW, 1e6, {
      measure: (char) => measureText(char, this.font)
    });
    engine.preserveLeadingSpaces = true;
  ...
  render(r) {
    ...
    const baselineOffset = cssLineBoxBaseline2(this.font, lh);
    r.save();
...
var LinkHotspot = class extends UIComponent {
  ...
  constructor(href, onClick) {
    ...
    this.interactive = true;
    this.on("click", () => {
      const safe = sanitizeUrl2(this.href);
      if (safe && safe !== "#") onClick?.(safe);
    });
  }
  getA11yAttributes() {
    return { tag: "a", href: sanitizeUrl2(this.href), label: this.href, target: "_blank" };
  }
  render() {
  }
};
...
var RichText = class extends UIComponent {
  ...
  constructor(spans, opts = {}) {
    ...
    this.engine = new LayoutEngine4(this.maxWidth ?? 1e9, 1e9, baseMeasurer(this.font));
    this.interactive = false;
...
// src/ScrollView.ts
import { Entity as Entity2 } from "@vectojs/core";
var ScrollView = class extends UIComponent {
  ...
  constructor(opts) {
    ...
    this.content = new class extends Entity2 {
      isPointInside() {
        return false;
      }
      render() {
...
var htmlMathJax = mathjax.document("", { InputJax: tex, OutputJax: svg });
...
var HorizontalRule = class extends Entity3 {
  color;
  constructor(w, color) {
    super();
    this.width = w;
...
var QuoteBorder = class extends Entity3 {
  color;
...
var MarkdownContainer = class extends Entity3 {
...
// src/Dropdown.ts
import { Entity as Entity4 } from "@vectojs/core";
var Dropdown = class extends UIComponent {
  ...
  openMenu() {
    ...
    const backdrop = new class Backdrop extends Entity4 {
      isPointInside() {
        return true;
      }
      render() {
...
// src/ContextMenu.ts
import { Entity as Entity5 } from "@vectojs/core";
...
var ContextMenu = class _ContextMenu extends Overlay {
  ...
  showAtPoint(x, y, source) {
    ...
    if (this._parentMenu === null && !this._backdrop && scene) {
      const backdrop = new class ContextMenuBackdrop extends Entity5 {
        isPointInside() {
          return true;
        }
        render() {
