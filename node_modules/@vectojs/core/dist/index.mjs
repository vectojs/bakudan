...
var ComputeParticleEntity = class extends Entity {
  maxParticles;
  springK;
  damping;
  bounceDamping;
  ...
  constructor(options = {}) {
    ...
    this.maxVelocity = options.maxVelocity ?? 500;
...
var Scene = class _Scene {
  ...
  a11yPendingSyncAfterAnimation = false;
...
var TextEntity = class extends Entity {
  ...
  constructor(text, atlas, maxWidth, fontSize = 24) {
    ...
    this.layout = new LayoutEngine(maxWidth, 1e4, defaultMeasurer());
