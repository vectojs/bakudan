 ...
 * clip. Entries don't need to be in time order — `DanmakuTrack` sorts them
 * at construction. Mixing preset per entry showcases several motion styles
 * within a single short playback instead of defaulting every timed comment
 * to `scroll`.
 */
